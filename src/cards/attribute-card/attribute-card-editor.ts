...
import "../../shared/editor/attributes-picker";
...
import { AttributeCardConfig, entityCardConfigStruct } from "./attribute-card-config";

const actions = ["toggle", "more-info", "navigate", "url", "call-service", "none"];

@customElement(ENTITY_CARD_EDITOR_NAME)
export class AttributeCardEditor extends LitElement implements LovelaceCardEditor {
    ...
    public setConfig(config: AttributeCardConfig): void {
