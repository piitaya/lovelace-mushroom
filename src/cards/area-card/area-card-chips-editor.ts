...
@customElement("mushroom-area-card-chips-editor")
export class AreaCardEditorChips extends MushroomBaseElement {
  ...
  protected render() {
    ...
    return html`
      ...
      >
        ${CHIP_LIST.filter((chip) => ["entity", "light"].includes(chip)).map(
          (chip) => html`
