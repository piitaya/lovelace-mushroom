...
export const lightSupportsColorMode = (entity: LightEntity, mode: LightColorModes) =>
...
export const lightSupportsDimming = (entity: LightEntity) =>
    entity.attributes.supported_color_modes?.some((mode) => modesSupportingDimming.includes(mode));
